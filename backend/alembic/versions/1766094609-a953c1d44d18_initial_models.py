...
Revision ID: a953c1d44d18
Revises:
Create Date: 2025-12-18 21:50:09.859512+00:00
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("average_cycle_length", sa.Float(), nullable=True),
        sa.Column("average_period_length", sa.Float(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "flow_intensity",
            sa.Enum("none", "spotting", "light", "medium", "heavy"),
            nullable=True,
        ),
